...
class Hotel {
    ...
    void rent(Room t) throws Exception {
        ...
        while(temp!=null){
            Room current = temp.info;
            if(current.getStatus() == 0 
                    && current.getPrice() <= t.getPrice() 
                    && current.getSize() >= t.getSize()){
    ...
    void f2() throws Exception {
        ...
        //You should write here appropriate statements to complete this function.
        //--------------------------------------------------------
        Room requestRoom = RQueue.deQueue();
        if(requestRoom!=null){
            rent(requestRoom);
        }
        //---------------------------------------------------------
    ...
    void f4() throws Exception {
        ...
        Node temp = dList.head;
        while (temp!=null) {            
            if(temp.info.getStatus()==1){
                result+= temp.info.getPrice();
            }
            temp = temp.next;
        }
        //---------------------------------------------------------
